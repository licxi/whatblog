		...
		<div class="row">
			<div class="col-lg-12">
				<div class="wrapper wrapper-content animated fadeInUp">
					<ul class="notes">
						<li>
							<div style="color: #fff; background: #17987E; overflow: hidden;">
								<small>2016212</small>
								<p style="font-size: medium; margin-top: 20px;">这是什么呢这是什么呢这是什么呢这是什么呢这是什么呢这是什么呢这是什么呢这是什么呢</p>
								<a href="#"><i class="fa fa-paint-brush"></i>from 刘岑溪</a>
							</div>
						</li>
						<li>
							<div style="color: #fff; background: #17987E; overflow: hidden;">
