				...
				<div id="carousel-example-generic" class="carousel slide"
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<a
								href="http://www.17sucai.com/preview/512263/2016-04-05/%E5%BC%82%E6%B8%85%E8%BD%A9%E5%8D%9A%E5%AE%A28/content.html"
							...
							<c:forEach items="${newArticles }" var="article">
								<div class="news-list">
									...
									<div class="news-info col-xs-9 col-sm-9 col-md-9">
										<dl>
											<dt>
												<a href="" target="_blank"> ${article.articleTitle } </a>
											</dt>
											<dd>
												<span class="name"><a href="" title=""
										...
										<div class="news_bot col-sm-7 col-md-8">
											<!-- <span class="tags visible-lg visible-md"> <a href="">本站</a>
												<a href="">异清轩</a>
											</span> --> <span class="look"> 共 <strong>${article.articleClick }</strong> 人围观， <strong>
													${article.commentsCount }</strong> 个评论
											</span>
										</div>
									</div>
								</div>
