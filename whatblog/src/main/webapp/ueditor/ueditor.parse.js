    ...
    if(pres.length){
        if(typeof XRegExp == "undefined"){
            ...
            if(this.rootPath !== undefined){
                ...
                cssurl = utils.removeLastbs(this.rootPath) + '/third-party/SyntaxHighlighter/shThemeMidnight.css';
/*                cssurl = utils.removeLastbs(this.rootPath) + '/third-party/SyntaxHighlighter/shDark.css';
